...
> 关联文档：[Clickjacking](../Clickjacking/README.md) · [Iframe Traps](../Iframe%20Traps/README.md) · [XSS](../../Reflected%20Values/XSS/README.md) · [Cookies Hacking](../Cookies%20Hacking/README.md)
...
### 4.1.1 self + unsafe-inline via Iframes
...
## 4.5 缺失 object-src 或 default-src
...
## 5.1 CDN + AngularJS Gadget Chains
...
## 6.1 RPO (Relative Path Overwrite)
...
# 0x07 Iframe CSP 绕过技术

## 7.1 Iframe 基本 CSP 绕过
...
## 7.3 Dangling Markup / Named-Iframe 数据窃取 (2023)
...
## 7.6 Credentialless Iframes (Chrome 110+)
...
## 7.7 fetchLater Attack (Chrome 135+, April 2025)
...
## 8.7 CSP 限制攻击 (Restricting CSP to Bypass CSP)
...
## 8.8 Content-Security-Policy-Report-Only 信息泄露
...
# 0x0C `'unsafe-inline'` + `img-src *` 组合攻击
...
## 12.1 img-src *; via XSS (iframe) — 时间侧信道
...
## 13.3 链 3：Iframe Error Page → 脚本执行
...
## 13.6 链 6：Policy Injection → Defense Nullification
