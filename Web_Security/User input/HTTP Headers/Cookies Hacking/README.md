...
# Cookies Hacking — Cookie 全攻击面指南

> 关联文档：[CORS](../CORS%20Misconfigurations%20%26%20Bypass/README.md) · [CSP Bypass](../CSP%20Bypass/README.md) · [XSS](../../Reflected%20Values/XSS/README.md) · [XS-Search](../../Reflected%20Values/XS-Search/README.md) · [CRLF Injection](../../Reflected%20Values/CRLF/README.md)

---

# 0x01 Cookie 基础属性与安全模型
...
### 4.1.1 Chrome Unicode Surrogate Bug
...
### 5.1.2 Cookie 注入（Cookie Injection）
...
# 0x07 Cookie Bomb + XS-Leak (onerror 预言机)
